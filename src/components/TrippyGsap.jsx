...
function Logo() {
  return (
    ...
    >
      <svg id="logo-73" width="60" height="40" viewBox="0 0 60 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        {' '}
...
function generateSections(count, color) {
...
function Trippy() {
  return (
    <div className="absolute inset-0 overflow-hidden bg-black trippy">
      {generateSections(0, 'white')}
    </div>
  )
}
...
function Section({ background, children }) {
  return (
    <div
      className="relative w-full h-full origin-center section"
      style={{
        background,
        padding: PADDING,
      }}
